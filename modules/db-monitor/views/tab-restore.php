...
<div class="mad-dbm-restore">
    ...
    <div class="notice notice-warning inline">
        <p>
            ...
            <?php esc_html_e( 'Solo se pueden restaurar archivos .sql.gz exportados por este mismo plugin. Las tablas críticas de WordPress y WooCommerce no pueden restaurarse desde aquí. La restauración puede sobrescribir datos actuales.', 'mad-suite' ); ?>
        </p>
    </div>
    ...
    <!-- Step 2: Preview (populated via AJAX / redirect) -->
    <div id="mad-dbm-restore-step-2" class="mad-dbm-restore-step" style="display:none">
        ...
        <table class="form-table" id="mad-dbm-restore-preview-table">
            <tr>
            ...
            <tr>
                <th><?php esc_html_e( 'Registros aproximados', 'mad-suite' ); ?></th>
        ...
        <p>
            <label>
                <input type="checkbox" id="mad-dbm-restore-confirm-check">
                <?php esc_html_e( 'Confirmo que quiero restaurar esta tabla y entiendo que se sobrescribirán los datos actuales.', 'mad-suite' ); ?>
            </label>
        </p>
        ...
        <div class="mad-dbm-modal-actions">
            ...
            <button class="button" id="mad-dbm-restore-cancel-btn">
                <?php esc_html_e( 'Cancelar', 'mad-suite' ); ?>
            </button>
        </div>

        <input type="hidden" id="mad-dbm-restore-tmp-path" value="">
